---
tags: [code, py, v2]
path: brain_regions.py
lines: 35
---
# brain_regions.py

> [!info] Source file (v2)
> `brain_regions.py` &middot; 35 lines &middot; The 25 supported brain regions and their MNI (x,y,z) coordinates, with lookup helpers.

## Connected notes
[[visualization]] &middot; [[app]]
