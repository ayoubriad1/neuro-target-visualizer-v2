...
# Pre-warm nilearn's fsaverage mesh + atlas caches at build time so the first
# request from a researcher isn't the one paying the download cost (and
# works offline afterwards / behind restrictive lab network policies).
